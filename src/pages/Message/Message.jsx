    ...
    <div className="container mx-auto px-4" style={{ marginTop: '150px' }}>
      <div className="about flex items-center justify-between">
        <div className="about-left flex-4 relative">
          ...
          <img src={play_icon} alt="" className="play-icon w-16 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
        </div>
        <div className="about-right flex-6 pl-12">
          <h3 className="font-semibold text-blue-700 text-lg pb-2">About VSE&T</h3>
          <h2 className="text-3xl font-bold">Nurturing Tomorrow's Leaders Today</h2>
